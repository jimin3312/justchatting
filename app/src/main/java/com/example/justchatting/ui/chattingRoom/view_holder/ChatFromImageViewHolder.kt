...
class ChatFromImageViewHolder(itemView : View): RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(chatMessage: ChatMessage) {
        ...
        val profileImage = itemView.findViewById<CircleImageView>(R.id.chat_from_image_profile_image)
